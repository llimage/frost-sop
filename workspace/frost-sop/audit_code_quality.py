...
def audit_pylint():
    ...
    # 解析结果
    try:
        with open("audit_results/pylint_errors.json", encoding="utf-8") as f:
            data = json.load(f)
...
def audit_flake8():
    ...
    if result.returncode != 0:
        try:
            with open("audit_results/flake8_issues.json", encoding="utf-8") as f:
                data = json.load(f)
...
def generate_summary():
    ...
    # 读取 Pylint 结果
    try:
        with open("audit_results/pylint_errors.json") as f:
    ...
    # 读取 Flake8 结果
    try:
        with open("audit_results/flake8_issues.json") as f:
