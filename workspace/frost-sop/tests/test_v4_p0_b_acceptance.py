...
class TestAC4Analytics:
    ...
    def test_analyze_finance_light(self):
        ...
        context = {"_asset_store": self.mock_store, "_analysis_depth": "light"}
...
class TestAC5Hunt:
    ...
    def test_search_external(self):
        ...
        context = {"_asset_store": self.mock_store, "_hunt_target_skill_id": "test_skill"}
    ...
    def test_hunt_sop_no_targets(self):
        ...
        context = {"_asset_store": self.mock_store, "_hunt_targets": []}
    ...
    def test_trigger_continuous_hunt(self, mock_load):
        ...
        context = {"_asset_store": self.mock_store}
