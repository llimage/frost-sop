...
class TestArmoryRegistryV5:
    ...
    def test_count(self):
        ...
        r = ArmoryRegistry()
        assert r.count() == 0
        r.register(Weapon(id="skill:a", name="a", type=WeaponType.SKILL, category=FunctionDomain.COGNITIVE))
        r.register(Weapon(id="skill:b", name="b", type=WeaponType.SKILL, category=FunctionDomain.COGNITIVE))
        assert r.count() == 2
    ...
    def test_list_active(self):
        ...
        w1 = Weapon(
            ...
            state=WeaponStatus.ACTIVE, health_score=80.0,
        )
        w2 = Weapon(
            id="skill:b", name="b", type=WeaponType.SKILL, category=FunctionDomain.COGNITIVE,
            state=WeaponStatus.DISCOVERED, health_score=50.0,
        )
        r.register(w1)
        r.register(w2)
    ...
    def test_search_by_domain(self):
        ...
        r = ArmoryRegistry()
        w1 = Weapon(id="skill:a", name="a", type=WeaponType.SKILL, category=FunctionDomain.COGNITIVE)
    ...
    def test_update_status(self):
        ...
        w = Weapon(
            ...
            state=WeaponStatus.DISCOVERED, health_score=80.0,
        )
        r.register(w)
    ...
    def test_record_usage(self):
        ...
        r = ArmoryRegistry()
        w = Weapon(id="skill:test", name="test", type=WeaponType.SKILL, category=FunctionDomain.COGNITIVE)
        r.register(w)
        ...
        class MockSkillRegistry:
            def __init__(self):
                self._catalog = {
                    ...
                    "assemble_agent": {"name": "assemble_agent", "description": "Agent 组装", "func": None},
                }
...
class TestV4BackwardCompat:
    ...
    def test_v4_list_all_still_works(self):
        """V4.0 list_all() 仍然可用"""
        r = ArmoryRegistry()
        r.register(Weapon(id="skill:a", name="a", type=WeaponType.SKILL, category=WeaponCategory.COGNITIVE))
        r.register(Weapon(id="sop:b", name="b", type=WeaponType.SOP, category=WeaponCategory.EXECUTION))
