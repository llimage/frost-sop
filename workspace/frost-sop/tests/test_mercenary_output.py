...
from skills.mercenary import mercenary_date, mercenary_keywords, mercenary_md2html
...
def test_mercenary_output():
    ...
    all_passed = (
        md_result["failed"] == 0 and keyword_result["failed"] == 0 and date_result["failed"] == 0
    )
