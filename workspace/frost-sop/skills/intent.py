...
_KNOWN_SOPS = {
    ...
    "REDBOOK-001": {
        "id": "REDBOOK-001",
        "name": "小红书运营",
        "trigger_keywords": ["小红书", "红书", "种草", "笔记", "小红书运营", "redbook"],
    },
    "JUEJIN-001": {
        "id": "JUEJIN-001",
        "name": "掘金发布",
        "trigger_keywords": ["掘金", "技术文章", "掘金技术", "juejin", "掘金发布"],
    },
    "EMAIL-001": {
        "id": "EMAIL-001",
        "name": "邮件Newsletter",
        "trigger_keywords": ["newsletter", "邮件", "邮件营销", "订阅", "newsletter发送", "email"],
    },
}
...
输出格式：
{
    "task_type": "任务类型（开发/Bug修复/内容发布/财务/运维/知识管理/项目管理/小红书运营/掘金发布/邮件Newsletter/其他）",
    "confidence": 0.0-1.0,
...
- REDBOOK-001 小红书运营：小红书笔记、种草内容
- JUEJIN-001 掘金发布：掘金技术文章发布
- EMAIL-001 邮件Newsletter：邮件订阅、Newsletter发送
...
def _parse_intent_with_llm(user_input: str) -> dict:
    ...
    try:
        result, err = safe_json_parse(response)
...
def get_sop_info(sop_id: str | None) -> dict | None:
    """获取 SOP 模板详细信息。"""
